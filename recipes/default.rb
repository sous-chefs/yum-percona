...
yum_repository 'percona' do
  ...
  gpgkey node['yum']['percona']['gpgkey'] if  node['yum']['percona']['gpgkey'].nil?
  ...
  http_caching node['yum']['percona']['http_caching'] if  node['yum']['percona']['http_caching'].nil?
  ...
  mirror_expire node['yum']['percona']['mirror_expire'] if  node['yum']['percona']['mirror_expire'].nil?
  ...
  proxy_username node['yum']['percona']['proxy_username'] if  node['yum']['percona']['proxy_username'].nil?
  proxy_password node['yum']['percona']['proxy_password'] if  node['yum']['percona']['proxy_password'].nil?
  ...
  timeout node['yum']['percona']['timeout'] if  node['yum']['percona']['timeout'].nil?
  action :create
end
